...
void D3D12HelloWindow::LoadAssets()
{
	...
	// Create the vertex buffer.
	{
		...
		{
			{ { 0.0f, 0.2f * m_aspectRatio, 0.0f }, { 0.5f, 0.8f, 0.3f, 1.0f } },
			{ { 0.5f, -0.25f * m_aspectRatio, 0.0f }, { 0.6f, 0.77f, 0.35f, 0.5f } },
			{ { -0.25f, -0.25f * m_aspectRatio, 0.0f }, { 0.8f, 0.5f, 0.2f, 0.05f } }
		};
...
void D3D12HelloWindow::PopulateCommandList()
{
	...
	// Record commands.
	const float clearColor[] = { 1.0f, 0.7f, 0.75f, 1.0f };
